...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v6.12.tar.gz
...
%prep
%setup -q -n btrfs-progs-v6.12
cd %{_builddir}/btrfs-progs-v6.12
pushd ..
cp -a btrfs-progs-v6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733168441
