...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v5.18.tar.xz
...
%prep
%setup -q -n btrfs-progs-v5.18
cd %{_builddir}/btrfs-progs-v5.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653504491
...
cp %{_builddir}/btrfs-progs-v5.18/COPYING %{buildroot}/usr/share/package-licenses/btrfs-progs/ef1bcf369e4124b5f2558fefee17972f41b76cab
cp %{_builddir}/btrfs-progs-v5.18/libbtrfsutil/COPYING %{buildroot}/usr/share/package-licenses/btrfs-progs/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
