...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707323696
...
/VA/usr/bin/btrfs
/VA/usr/bin/btrfs-convert
/VA/usr/bin/btrfs-find-root
/VA/usr/bin/btrfs-image
/VA/usr/bin/btrfs-map-logical
/VA/usr/bin/btrfs-select-super
/VA/usr/bin/btrfstune
/VA/usr/bin/mkfs.btrfs
/usr/bin/btrfs
...
/VA/usr/lib64/libbtrfs.so.0.1
/VA/usr/lib64/libbtrfsutil.so.1.2.0
