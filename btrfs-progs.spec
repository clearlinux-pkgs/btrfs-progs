...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v5.19.tar.xz
...
%prep
%setup -q -n btrfs-progs-v5.19
cd %{_builddir}/btrfs-progs-v5.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660663855
