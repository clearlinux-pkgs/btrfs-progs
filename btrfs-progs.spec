...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v5.19.1.tar.xz
...
%prep
%setup -q -n btrfs-progs-v5.19.1
cd %{_builddir}/btrfs-progs-v5.19.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663017386
