...
Source0  : https://www.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v5.6.tar.xz
...
%prep
%setup -q -n btrfs-progs-v5.6
cd %{_builddir}/btrfs-progs-v5.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586270162
...
cp %{_builddir}/btrfs-progs-v5.6/COPYING %{buildroot}/usr/share/package-licenses/btrfs-progs/ef1bcf369e4124b5f2558fefee17972f41b76cab
cp %{_builddir}/btrfs-progs-v5.6/libbtrfsutil/COPYING %{buildroot}/usr/share/package-licenses/btrfs-progs/31a3d460bb3c7d98845187c716a30db81c44b615
cp %{_builddir}/btrfs-progs-v5.6/libbtrfsutil/COPYING.LESSER %{buildroot}/usr/share/package-licenses/btrfs-progs/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
%make_install
