...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v6.9.1.tar.gz
...
%prep
%setup -q -n btrfs-progs-v6.9.1
cd %{_builddir}/btrfs-progs-v6.9.1
pushd ..
cp -a btrfs-progs-v6.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719271294
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbtrfs.so.0.1.3
/V3/usr/lib64/libbtrfsutil.so.1.3.1
/usr/lib64/libbtrfs.so.0
/usr/lib64/libbtrfs.so.0.1
/usr/lib64/libbtrfs.so.0.1.3
/usr/lib64/libbtrfsutil.so.1
/usr/lib64/libbtrfsutil.so.1.3
/usr/lib64/libbtrfsutil.so.1.3.1
