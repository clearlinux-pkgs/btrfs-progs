...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v6.10.1.tar.gz
...
%prep
%setup -q -n btrfs-progs-v6.10.1
cd %{_builddir}/btrfs-progs-v6.10.1
pushd ..
cp -a btrfs-progs-v6.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723729833
