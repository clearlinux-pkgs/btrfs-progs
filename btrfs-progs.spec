...
Source0  : https://mirrors.kernel.org/pub/linux/kernel/people/kdave/btrfs-progs/btrfs-progs-v6.0.tar.xz
...
%prep
%setup -q -n btrfs-progs-v6.0
cd %{_builddir}/btrfs-progs-v6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665494661
